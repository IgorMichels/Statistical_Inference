...
\begin{figure}[H]
    \includegraphics[page = 1]{3º Trabalho/Tikz1.pdf}
    \includegraphics[page = 2]{3º Trabalho/Tikz1.pdf}
...
\noindent e o intervalo de confiança sendo o intervalo $(8.065026690836966, 8.563063637406422)$.
...
\begin{multicols}{2}
    \begin{figure}[H]
        \includegraphics[page = 1]{3º Trabalho/Tikz2.pdf}
        \caption{Caso em que $\frac{\beta_0}{\alpha_0} = \frac{1}{4}$.}
    \end{figure}
    \begin{figure}[H]
        \includegraphics[page = 2]{3º Trabalho/Tikz2.pdf}
        \caption{Caso em que $\frac{\beta_0}{\alpha_0} = \frac{1}{25}$.}
    \end{figure}
    \begin{figure}[H]
        \includegraphics[page = 1]{3º Trabalho/Tikz3.pdf}
        \caption{Caso em que $\frac{\beta_0}{\alpha_0} = \frac{29}{200}$.}
    \end{figure}
    \begin{figure}[H]
        \includegraphics[page = 2]{3º Trabalho/Tikz3.pdf}
