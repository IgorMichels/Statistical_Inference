...
\begin{multicols}{2}
    ...
    \begin{figure}[H]
        \begin{tikzpicture}
            \begin{axis}[domain = 5:15, samples = 100, height = 5 cm, width = 8 cm, enlargelimits = upper]
                \addplot [domain = 5:8.176218214379208, draw = black] {student(18, 8.321955338966417, 0.004562815253362879)} \closedcycle;
                \addplot [domain = 8.441787865313305:15, draw = black] {student(18, 8.321955338966417, 0.004562815253362879)} \closedcycle;
                \addplot [domain = 8.176218214379208:8.441787865313305, draw = black] {student(18, 8.321955338966417, 0.004562815253362879)} \closedcycle;
                \addplot [draw = blue] {student(18, 8.321955338966417, 0.004562815253362879)};
                \addplot [draw = cyan] {student(8, 10, 3.9453998699999997)};
                \addplot [domain = 8.176218214379208:8.441787865313305, draw = red, samples = 2, line width=0.1cm] {0};
            \end{axis}
        \end{tikzpicture}
...
Por fim, talvez seria interessante alguém falar com Palmirinha para que ela encontre um assistente menos guloso e, principalmente, guardar seus parâmetros de priori.
